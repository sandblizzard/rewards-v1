...
pub const FEE_REC: u64 = 200; // 0.5%

// metadata
pub const METADATA_NAME: &str = "Sand";
pub const METADATA_SYMBOL: &str = "SAND";
pub const METADATA_URI: &str = "https://sandblizzard.one/metadata";
