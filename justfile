...
upgrade_devnet:
    @echo "Deploying Bounty to devnet ..."
    anchor upgrade --provider.cluster {{rpc_url_devnet}} --provider.wallet ~/.config/solana/id.json --program-id 5Hwbrh6QMrHvBNZfYXmsktWtfohcSSCMaC5Er9ErwNoQ target/deploy/bounty.so
